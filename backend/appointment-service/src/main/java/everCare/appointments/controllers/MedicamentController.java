...
public class MedicamentController {
    ...
    public ResponseEntity<Medicament> createMedicament(
            ...
            @RequestHeader(value = "X-Admin-Actor", required = false) String actorEmail) {
        accessControlService.assertAdminAccess();
        Medicament createdMedicament = medicamentService.createMedicament(medicament, actorEmail);
    ...
    public ResponseEntity<Page<Medicament>> filterMedicaments(
        ...
        return ResponseEntity.ok(
                medicamentService.filterMedicaments(
                        keyword,
                        actif,
                        laboratoire,
                        forme,
    ...
    public ResponseEntity<List<Medicament>> getMedicamentsByLaboratoire(
            @PathVariable String laboratoire) {

        return ResponseEntity.ok(
                medicamentService.getMedicamentsByLaboratoire(laboratoire)
        );
    }
    ...
    public ResponseEntity<List<Medicament>> getMedicamentsByForme(
            @PathVariable String forme) {

        return ResponseEntity.ok(
                medicamentService.getMedicamentsByForme(forme)
        );
    }
    ...
    public ResponseEntity<Medicament> updateMedicament(
        ...
        accessControlService.assertAdminAccess();
        return ResponseEntity.ok(
                medicamentService.updateMedicament(id, medicament, actorEmail)
        );
    }
    ...
    public ResponseEntity<Medicament> activateMedicament(
            @PathVariable String id,
            @RequestHeader(value = "X-Admin-Actor", required = false) String actorEmail) {
        accessControlService.assertAdminAccess();
        return ResponseEntity.ok(
                medicamentService.activateMedicament(id, actorEmail)
        );
    }
    ...
    public ResponseEntity<Medicament> deactivateMedicament(
            @PathVariable String id,
            @RequestHeader(value = "X-Admin-Actor", required = false) String actorEmail) {
        accessControlService.assertAdminAccess();
        return ResponseEntity.ok(
                medicamentService.deactivateMedicament(id, actorEmail)
        );
    }
    ...
    public ResponseEntity<Medicament> updatePhoto(
            @PathVariable String id,
        ...
        accessControlService.assertAdminAccess();
        return ResponseEntity.ok(
                medicamentService.updatePhoto(id, photoUrl, actorEmail)
        );
    }
    ...
    public ResponseEntity<Medicament> updateNotice(
            @PathVariable String id,
        ...
        accessControlService.assertAdminAccess();
        return ResponseEntity.ok(
                medicamentService.updateNotice(id, notice, actorEmail)
        );
    }
    ...
    // =========================================================
    // ANALYTICS - ACCESS CONTROL BYPASSED
    // =========================================================
    ...
    public ResponseEntity<MedicamentAnalyticsSummaryDTO> getAnalyticsSummary() {
        ...
        // No access control
        return ResponseEntity.ok(
                medicamentService.getAnalyticsSummary(null)
        );
    }
    ...
    public ResponseEntity<List<MedicamentUsageStatsDTO>> getUsageStats(
        ...
        // No access control
        return ResponseEntity.ok(
                medicamentService.getUsageStats(null, limit)
        );
    }
    ...
    public ResponseEntity<MedicationDosingRulesDTO> getDosingRules(
            @PathVariable String id) {
        ...
        return ResponseEntity.ok(
                MedicationDosingRulesDTO.builder()
