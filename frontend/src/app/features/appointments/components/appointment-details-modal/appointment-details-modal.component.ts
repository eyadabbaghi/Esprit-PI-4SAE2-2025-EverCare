...
export class AppointmentDetailsModalComponent {
  ...
  // <svg class="inline-svg-icon text-green-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true"><path d="m5 12 4 4L19 6" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"></path></svg> Simple Jitsi navigation — same room for doctor and patient
